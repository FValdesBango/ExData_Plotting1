...
#We use a call to plot as long as it is said to as this plot were created using
#the basic grapic tool of R
        with(hpcsbt,plot(Complete.Time,Global_active_power,
