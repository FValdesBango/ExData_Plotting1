...
png(file="plot4.png", width = 480, height = 480)
        ...
        with(hpcsbt,plot(Complete.Time,Global_active_power,xlab = "",ylab = "Global Active Power", type = "l"))

        with(hpcsbt,plot(Complete.Time,Voltage,xlab = "datetime",ylab = "Voltage", type = "l"))

        with(hpcsbt,plot(Complete.Time,Sub_metering_1,xlab = "",ylab = "Energy sub metering", type = "n"))
        ...
        with(hpcsbt,plot(Complete.Time,Global_reactive_power,xlab = "datetime",ylab = "Global_reactive_power", type = "l"))
